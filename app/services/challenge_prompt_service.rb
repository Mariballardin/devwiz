...
class ChallengePromptService
  ...
  def build_challenge_prompt
    "Consider a coding challenge with a single page response for a programmer who wants to prepare for an interview for the job position of #{@challenge_prompt.job_title}
